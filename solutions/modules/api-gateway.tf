...
resource "aws_api_gateway_integration" "trump" {
  ...
  type                    = "AWS_PROXY"
  uri                     = module.lambda_trump_quote.invoke_arn
}
...
resource "aws_lambda_permission" "this" {
  statement_id  = "AllowAPIGatewayInvoke-${module.lambda_trump_quote.function_name}-${aws_api_gateway_method.trump.resource_id}-${aws_api_gateway_method.trump.http_method}"
  action        = "lambda:InvokeFunction"
  function_name = module.lambda_trump_quote.function_name
